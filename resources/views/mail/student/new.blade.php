...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #444444; line-height: 200%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 200%;"><span style="font-size: 22px; line-height: 44px;">Hi,</span><br /><span style="font-size: 16px; line-height: 32px;">Welcome to the American Council platform for distance learning of English language. Your request has been accepted. for information and inquiries, contact this link</span></p>
  </div>
