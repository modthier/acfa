...
<div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
  ...
  border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
  ...
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="{{ asset('images/image-1.png') }}" alt="Image" title="Image"
       ...
       border: none;height: auto;float: none;width: 26%;max-width: 150.8px;" width="150.8"/>
...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #444444; line-height: 200%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 200%;"><span style="font-size: 22px; line-height: 44px;">Hi,{{ $subscription->subscriptionable->trainer->name }}
    </span><br /><span style="font-size: 16px; line-height: 32px;">New subscription To your course</span></p>
  </div>
...
<div class="u-row-container" style="padding: 0px;background-color: transparent">
  ...
  break-word;word-break: break-word;background-color: #f9f9f9;">
    <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
      <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 
        0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
            <tr style="background-color: #f9f9f9;"><![endif]-->
      
<!--[if (mso)|(IE)]><td align="center" width="600" style="width: 600px;padding: 0px;border-top: 0px solid transparent;
    border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
<div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
  <div style="width: 100% !important;">
...
<table class="table">
  <tbody>
    <tr>
      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 0px;font-family:'Open Sans',sans-serif;" align="left">
        <div style="color: #444444; line-height: 200%; text-align: center; word-wrap: break-word;">
        Student Name : {{ $subscription->user->name }}
        </div>
      </td>
    </tr>
    <tr>
      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 0px;font-family:'Open Sans',sans-serif;" align="left">
        <div style="color: #444444; line-height: 200%; text-align: center; word-wrap: break-word;">
        Course Name : {{ $subscription->subscriptionable->name }}
        </div>
      </td>
    </tr>
  </tbody>
